...
public class SlotMachine extends AppCompatActivity {
    ...
    void rollAnim(int max, int randNum1, int randNum2, int randNum3,TextView t1,TextView t2,TextView t3){
        ...
        animator2.setDuration(125*randNum1); //Duration is in milliseconds
        ...
        animator5.setDuration(125*randNum2); //Duration is in milliseconds
        ...
        animator9.setDuration(125*randNum3); //Duration is in milliseconds
